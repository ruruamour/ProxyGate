...
func DefaultConfig() *Config {
	...
	return &Config{
		// 基础服务配置
		WebUIPort:         envPort("WEBUI_PORT", "7778"),
		WebUIPasswordHash: passwordHash(password),
		ProxyPort:         envPort("RANDOM_PORT", "7777"),
		StableProxyPort:   envPort("STABLE_PORT", "7776"),
		SOCKS5Port:        envPort("SOCKS5_RANDOM_PORT", "7779"),
		StableSOCKS5Port:  envPort("SOCKS5_STABLE_PORT", "7780"),
